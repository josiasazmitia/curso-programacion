...
- [ ] Conectar repositorio remoto y hacer `git push`.
...
git init
git add .
git commit -m "feat: crear primera página html"
...
- `docs: semana 01 guía`
- `feat: agregar primera página html`
- `fix: corregir título del index`
...
- Subir el proyecto sin `README.md`.
